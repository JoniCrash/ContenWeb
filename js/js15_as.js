(function() {
      ...
      , l = function(n, r) {
        ...
        try {
                ...
                if (!i.o_i) {
                    ...
                    i.c_on > 0) {
                        ...
                        var o = 1e3
                          ...
                          , _ = 600 * o
                          , f = 45 * o;
                        parseInt(i.o_n - i.d_mu) >= u && (qn("HstCmu", i.o_n),
                        i.d_mu = 0),
                        i.d_mu++,
                        j < 1 || F >= u ? (i.d_pn = 1,
                        i.d_cv = 1,
                        i.d_pt = 1,
                        i.d_cs = 1) : F > 0 && (F < c ? i.d_nv = 0 : (i.d_pn = 1,
                        i.d_cv++),
                        F > _ && i.d_cs++),
                        i.d_cv < 1 && (i.d_cv = 1),
                    ...
                    D(N) && 1 == i.d_nv && t < 1 ? qn("c_ref_", xn(N)) : (D(kn(Un("c_ref_" + wn()))) && (N = kn(Un("c_ref_" + wn()))),
                    D(N) || (N = "1000")),
                    i.d_op = Un("c_pd_" + wn()),
                    y(i.d_op) || (i.d_op = 0),
            ...
            i.track_hits = function() {
                yn() || (Yn(),
                J() ? (B = "i/" + wn() + ".gif?",
                i.load_gifImgOrTopImg()) : z() ? (B = L() + ".gif?",
                i.load_GIFicon()) : q() || W() ? (tt("1"),
                B = "0.php?",
                Kn(),
                lt()) : (B = wn() + ".php?",
                Kn()))
            ...
            var _t = {
              ...
              , dt = function() {
                ...
                ln(n, function() {
                    var n = r[at(L())]
                      , t = Rn();
                    t && (_t.counterObjInstance = n(ft(), r),
    ...
    i = i || o || a,
    i && (window["histats_counters_byType"] = window["histats_counters_byType"] || {},
